  ...
  <div class="min-h-screen bg-gray-50 dark:bg-surface-dark flex flex-col items-center justify-center px-4 transition-colors duration-500 neon-grid-bg">
    ...
    <div class="relative z-10 bg-white dark:bg-surface-card rounded-3xl shadow-2xl dark:shadow-[0_0_50px_rgba(0,0,0,0.3)] w-full max-w-md p-10 border border-gray-200 dark:border-surface-border">
      ...
      <form v-else @submit.prevent="onSubmit" class="space-y-6">
        ...
        <div class="space-y-2">
          <label for="reset-password-field" class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">New Password</label>
        ...
        <button id="reset-submit-button" type="submit" :disabled="loading || !token" class="w-full px-4 py-3.5 text-sm font-black uppercase tracking-widest bg-neon-cyan text-cyan-950 dark:text-gray-900 rounded-xl hover:bg-neon-cyan/90 disabled:opacity-50 transition-all hover:shadow-lg hover:shadow-neon-cyan/20 active:scale-[0.98]">
