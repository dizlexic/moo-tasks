...
<template>
  <BaseModal max-width="max-w-2xl" @close="closeModal">
      <template #header>
        <h2 class="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Create New Task</h2>
      ...
      <form @submit.prevent="onSubmit" class="space-y-5">
        ...
        <div class="space-y-1.5">
          <label for="new-task-description" class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">Description</label>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1.5">
              <label for="new-task-priority" class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">Priority</label>
              <div class="relative">
            ...
            <div class="space-y-1.5">
              <label for="new-task-difficulty" class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">Difficulty</label>
              <div class="relative">
        ...
        <div class="space-y-1.5">
          <label class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">Tags</label>
