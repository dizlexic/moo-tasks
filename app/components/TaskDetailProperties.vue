...
<template>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="space-y-1.5">
      <label for="task-status" class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">Status</label>
      <div class="relative">
    ...
    <div class="space-y-1.5">
      <label for="task-priority" class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">Priority</label>
      <div class="relative">
    ...
    <div class="space-y-1.5">
      <label for="task-difficulty" class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">Difficulty</label>
      <div class="relative">
    ...
    <div class="space-y-1.5">
      <label for="task-assignee" class="block text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 ml-1">Assignee</label>
      <div class="relative">
